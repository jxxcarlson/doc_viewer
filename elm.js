...
var _user$project$DocumentViewer$viewDocument = function (document) {
	return A2(
...
var _user$project$DocumentViewer$onKeyDown = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
...
var _user$project$DocumentViewer$initialModel = {
	...
	documents: {
		...
		_1: {
			ctor: '::',
			_0: _user$project$DocumentViewer$document2,
			_1: {ctor: '[]'}
		}
	},
	selectedDocument: _user$project$DocumentViewer$document1
};
...
var _user$project$DocumentViewer$documentDecoder = A3(
...
var _user$project$DocumentViewer$getDocuments = function (author_identifier) {
	var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$DocumentViewer$getDocumentsUrlPrefix, author_identifier);
	var request = _elm_lang$http$Http$getString(url);
	return A2(_elm_lang$http$Http$send, _user$project$DocumentViewer$GetDocuments, request);
};
var _user$project$DocumentViewer$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SelectDocument':
...
var _user$project$DocumentViewer$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$DocumentViewer$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$DocumentViewer$authorQueryForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$DocumentViewer$Input),
									_1: {
										ctor: '::',
										_0: _user$project$DocumentViewer$onKeyDown(_user$project$DocumentViewer$KeyDown),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$DocumentViewer$SelectDocument = function (a) {
	return {ctor: 'SelectDocument', _0: a};
};
var _user$project$DocumentViewer$viewTitle = F2(
			...
			_elm_lang$html$Html$li,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$DocumentViewer$SelectDocument(document)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$DocumentViewer$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$DocumentViewer$authorQueryForm(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$p,
...
var _user$project$DocumentViewer$main = _elm_lang$html$Html$program(
	{
...
var Elm = {};
Elm['DocumentViewer'] = Elm['DocumentViewer'] || {};
if (typeof _user$project$DocumentViewer$main !== 'undefined') {
    _user$project$DocumentViewer$main(Elm['DocumentViewer'], 'DocumentViewer', undefined);
}
