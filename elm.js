...
var _user$project$Types$InputAuthor = function (a) {
	return {ctor: 'InputAuthor', _0: a};
};
...
var _user$project$Types$GetAuthor = function (a) {
	return {ctor: 'GetAuthor', _0: a};
};
var _user$project$Types$GetDocuments = function (a) {
...
var _user$project$Types$SelectAuthor = function (a) {
	return {ctor: 'SelectAuthor', _0: a};
};
var _user$project$Types$SelectDocument = function (a) {
...
var _user$project$Action_Document$updateTitle = F2(
	function (model, title) {
		...
		var newDocument = _elm_lang$core$Native_Utils.update(
			...
			{
				title: title,
				identifier: _user$project$Utility$normalizeString(title)
			});
		return {
			ctor: '_Tuple2',
...
var _user$project$Action_Document$updateAuthor = F2(
	function (model, author) {
		...
		var newDocument = _elm_lang$core$Native_Utils.update(
			...
			{
				title: author,
				author_identifier: _user$project$Utility$normalizeString(author)
			});
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'selected',
							_1: _elm_lang$core$Native_Utils.eq(selectedDocument.title, document.title)
						},
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Types$SelectDocument(document)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Views_Document$viewDocument = function (document) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(document.text),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Views_Document$documentViewer = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('documentViewer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Views_Form$onKeyDown = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$keyCode));
};
var _user$project$Views_Form$authorQueryForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('authorForm'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('author_identifier'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('searchLabel'),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('author_identifier'),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$Views_Form$onKeyDown(_user$project$Types$KeyDown),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Views_Author$viewAuthor = F2(
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'selected',
							_1: _elm_lang$core$Native_Utils.eq(selectedAuthor.name, author.name)
						},
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Types$SelectAuthor(author)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Views_Author$authorSidebar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('authors'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Request_Author$getAuthors = function (author_identifier) {
	...
	return A2(_elm_lang$http$Http$send, _user$project$Types$GetAuthors, request);
};
var _user$project$Request_Author$getAuthor = function (author_identifier) {
	var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$Request_Api$getAuthorUrlPrefix, author_identifier);
	var request = _elm_lang$http$Http$getString(url);
	return A2(_elm_lang$http$Http$send, _user$project$Types$GetAuthor, request);
};

var _user$project$Request_Document$getDocuments = function (author_identifier) {
...
var _user$project$Views_Editor$editorTextPane = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Views_Editor$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Views_Editor$editorInputsPane = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Views_Editor$styles(
				{
					ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('title_input'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('title_input_label'),
						_1: {ctor: '[]'}
					}
				},
				{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(model.selectedDocument.title),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$InputTitle),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(model.selectedDocument.author),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$InputAuthor),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(model.selectedDocument.author_identifier),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Views_Editor$editorInputsPane(model),
							_1: {
								ctor: '::',
								_0: _user$project$Views_Editor$editorTextPane(model),
								_1: {ctor: '[]'}
							}
						}
					}),
		...
		switch (_p0.ctor) {
			...
			case 'SelectAuthor':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectedAuthor: _p1}),
					_1: _user$project$Request_Document$getDocuments(_p1.identifier)
				};
			case 'Input':
				return {
					ctor: '_Tuple2',
			...
			case 'KeyDown':
				return _elm_lang$core$Native_Utils.eq(_p0._0, 13) ? {
					...
					_1: _user$project$Request_Author$getAuthors(model.input_text)
			...
			case 'GoToEditor':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{page: _user$project$Types$EditorPage}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'GoToReader':
				return {
			...
			case 'InputTitle':
				return A2(_user$project$Action_Document$updateTitle, model, _p0._0);
			case 'InputAuthor':
				return A2(_user$project$Action_Document$updateAuthor, model, _p0._0);
			case 'Name':
